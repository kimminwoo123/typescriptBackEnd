...
describe('StudentService', () => {
    ...
    describe('studentRegistration', () => {
        it('수강생을 생성하고 수강생 객체를 반납한다', async () => {
            // give
            expect.assertions(1)
    ...
    describe('studentWithdrawal', () => {
        it('수강생 탈퇴시 수강생 객체 반납', async () => {
            // give
            expect.assertions(1)
            const student = Students.createStudent(2, '게롤트', 'gerolt@gmail.com', new Date(2022, 1, 22))
        ...
        it('가입되지 않은 수강생 받을시 error', async () => {
            // give
            expect.assertions(1)
            const student = Students.createStudent(1, '말레니아', 'malenia@gmail.com', new Date(2022, 1, 22))
    ...
    describe('lectureRegistration', () => {
        it('학생id와 강의id를 받아 수강신청 결과 반납', async () => {
            // give
            expect.assertions(1)
